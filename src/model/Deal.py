...
class Deal():
    ...
    def __init__(self, row):
        ...
        self.parkTotalPrice = row["車位總價(元)"]                  # 車位總價(元)
        self.belconyArea = row["陽台面積"]
        self.totalPrice = row["總價(元)"]                         # 總價(元)
        self.unitPrice = row["單價(元/平方公尺)"]                   # 單價(元/平方公尺)
        ###
